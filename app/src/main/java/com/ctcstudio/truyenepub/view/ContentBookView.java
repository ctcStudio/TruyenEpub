package com.ctcstudio.truyenepub.view;
...
import com.ctcstudio.truyenepub.utils.Config;
...
public class ContentBookView extends View {
    ...
    private String mTextFont = "DroidSans.ttf";
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!mTextFont.isEmpty()) {
            try {
                Typeface tf = Typeface.createFromAsset(context.getAssets(), Config.FONT_FOLDER + Config.SEPARATOR + mTextFont);
    ...
    public void setBookTextFont(String mTextFont) {
        ...
        if (!mTextFont.isEmpty()) {
            try {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), Config.FONT_FOLDER + Config.SEPARATOR + mTextFont);
                mTextPaint.setTypeface(tf);
            } catch (Exception ex) {
