...
import com.ctcstudio.truyenepub.adapter.SlidePagerAdapter;
import com.ctcstudio.truyenepub.entities.SettingBook;
import com.ctcstudio.truyenepub.fragment.ContentChapFragment;
import com.ctcstudio.truyenepub.task.SplitTextTask;
import com.ctcstudio.truyenepub.utils.Constants;
import com.ctcstudio.truyenepub.utils.LogUtils;
import com.ctcstudio.truyenepub.utils.SystemUiHider;
import com.ctcstudio.truyenepub.view.EBookViewPagerView;
...
public class ContentChapActivity extends ActionBarActivity implements SplitTextTask.onLoadAsync, ContentChapFragment.ContentCallBack, EBookViewPagerView.OnSwipeOutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eBook = BookApplication.get().getBook();
        settingBook = BookApplication.get().getSettingBook();
    ...
    protected void onPause() {
        super.onPause();
        BookApplication.get().setBookMark(posChap);
    ...
    private void showFontSetting() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BookApplication.get().setSettingBook(settingBook);
                mProgressBar.setVisibility(View.VISIBLE);
                new SplitTextTask(ContentChapActivity.this, dataContent, settingBook, ContentChapActivity.this).execute();
                dialog.dismiss();
